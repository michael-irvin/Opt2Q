...
"""
Case 10: TRAIL, Bid, Caspase-3 dependent model. Calibrates apoptosis model to data where TRAIL Bid and Caspase-3 are
independent variables:
    (IV) TRAIL concentration, and Bid expression via knockout, Caspase-3 activity via small molecule inhibitor
...
data = data_file[data_file.Condition.str.match(r'^Control$') | data_file.Condition.str.match(r'^siCtrl$') |
                 data_file.Condition.str.match(r'^BidKD') | data_file.Condition.str.contains(r'Caspase 3')]\
