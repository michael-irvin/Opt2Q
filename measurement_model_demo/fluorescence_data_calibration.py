...
sampled_params_0 = [SampledParam(norm, loc=-6, scale=1.0),  # x0  float  kf0 -- 95% bounded in ( -8, -4)
                    ...
                    SampledParam(norm, loc=-6, scale=1.0),  # x27 float  kc8 -- 95% bounded in (-9,  -3) eff-Caspase deg
                    ]
