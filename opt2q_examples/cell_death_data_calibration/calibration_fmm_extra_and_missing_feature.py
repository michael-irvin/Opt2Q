...
now = dt.datetime.now()
model_name = \
    f'apoptosis_model_tbid_cell_death_data_calibration_fmm_extra_and_missing_feature_{now.year}{now.month}{now.day}'
...
unr_coef = slope * 1.00   # "Unrelated_Signal" coef (0.00 --> 1.00) extra feature
