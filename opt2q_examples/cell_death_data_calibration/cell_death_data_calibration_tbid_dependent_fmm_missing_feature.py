...
# Calibrating the apoptosis model to pcd data using fixed measurement model that excludes a relevant feature
import os
import numpy as np
import pandas as pd
...
a = 4
tbid_classifier.set_params(**{'coefficients__apoptosis__coef_': np.array([[0.0, 0.25, 0.0]])*a,  # exclude 'time'
