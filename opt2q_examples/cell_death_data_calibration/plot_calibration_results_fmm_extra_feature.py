...
calibration_tag = 'fmm_extra_feature_2020910'
...
plt.suptitle('Convergence and Parameter Values for Cell Death Data \n '
             'Calibration (Fixed Measurement Model w/ Extra Feature)')
...
plt.suptitle('Parameter Value Traces and Histograms \n '
             'Cell Death Data Calibration (Fixed Measurement Model w/ Extra Feature)', y=0.95, fontsize=16)
plt.show()

fig, ax = plt.subplots()
ax.set_title('tBID Simulation using Random Sample from Posterior of Model Trained \n to Cell Death Data '
             '(Fixed Measurement Model w/ Extra Feature)')
