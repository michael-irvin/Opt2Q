...
with open(f'synthetic_WB_dataset_180s_2020_3_11.pkl', 'rb') as data_input:
...
now = dt.datetime.now()
model_name = f'apoptosis_params_and_immunoblot_classifier_calibration_180s_{now.year}{now.month}{now.day}'
