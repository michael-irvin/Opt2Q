...
sampled_params_0 = [SampledParam(norm, loc=true_params, scale=1.5),     # rate parameters floats
                    SampledParam(cauchy, loc=50.0, scale=0.1),          # coefficients__tBID_blot__coef_    float
                    SampledParam(cauchy, loc=0.2, scale=0.0005),           # coefficients__tBID_blot__theta_1  float
                    SampledParam(cauchy, loc=0.2, scale=0.0005),           # coefficients__tBID_blot__theta_2  float
                    SampledParam(cauchy, loc=0.2, scale=0.0005),           # coefficients__tBID_blot__theta_3  float
                    SampledParam(cauchy, loc=0.2, scale=0.0005),           # coefficients__tBID_blot__theta_4  float
                    SampledParam(cauchy, loc=50.0, scale=0.1),          # coefficients__cPARP_blot__coef_   float
                    SampledParam(cauchy, loc=0.25, scale=0.0005),           # coefficients__cPARP_blot__theta_1 float
                    SampledParam(cauchy, loc=0.25, scale=0.0005),           # coefficients__cPARP_blot__theta_2 float
                    SampledParam(cauchy, loc=0.25, scale=0.0005),           # coefficients__cPARP_blot__theta_3 float
                    ]
...
now = dt.datetime.now()
model_name = f'apoptosis_params_and_immunoblot_classifier_calibration_cauchy_0005_{now.year}{now.month}{now.day}'
