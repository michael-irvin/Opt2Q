...
plt.suptitle('Convergence and Parameter Values for Ordinal Data \n '
             'Calibration (Incorrect ad hoc Measurement Model)')
...
plt.suptitle('Parameter Value Traces and Histograms \n '
             'Ordinal Data Calibration (Incorrect ad hoc Measurement Model)', y=0.95, fontsize=16)
plt.show()

fig, ax = plt.subplots()
ax.set_title('tBID Simulation using Random Sample from Posterior \n of Model Trained to Ordinal Data '
             '(Incorrect ad hoc Measurement Model)')
...
classifier_params = random_post_measurement_model_parameters
...
tBID_results = lc_results.filter(regex='tBID_blot')
ax2.set_title('Incorrect ad hoc Measurement Model')
...
ax1.set_title('Normalized tBID 90% Credible Interval using Random Sample from Posterior '
              '\n of Model Trained to Ordinal Data, Using Incorrect ad hoc Measurement Model')
